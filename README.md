...
* [`src/tnt/`](src/tnt/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/tnt/core.cljs): contains the SPA entry point, `init`
...
The `debug?` variable in [`config.cljs`](src/cljs/tnt/config.cljs) defaults to `true` in
